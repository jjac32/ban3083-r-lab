...
## 📥 How to Submit Your Lab (Important!)

Because this browser session runs in the cloud without a login, **your session will reset if you close your tab for too long**. Follow these 3 steps to save and submit your work:

1. At the top of this pane (`Week01_SQL_to_R_Chinook.Rmd`), replace `[Type Your Name Here]` on Line 3 with your actual name.
2. Click the **🧶 Knit** button at the top of this pane. A complete HTML report with your code, SQL tables, and charts will pop up!
3. Look at the **Bottom-Right (Files) pane**:
   - Check the box `[x]` next to **`Week01_SQL_to_R_Chinook.html`**.
   - Click **More ⚙️** (in the Files pane toolbar) $\rightarrow$ **Export...** $\rightarrow$ **Download**.
   - Upload that `.html` file to our class page!
