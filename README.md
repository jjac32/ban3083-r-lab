# BAN 3083: Data Wrangling & Visualization in R
...
3. When finished, click **🧶 Knit** -> click the blue **Publish** icon -> select **RPubs**, and submit your `https://rpubs.com/...` link on Canvas!
